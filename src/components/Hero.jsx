  ...
  <section id="home" className={`flex md:flex-row flex-col ${styles.paddingY}`}>
    ...
    >
      ...
      <div className="flex flex-row justify-between items-center w-full">
        <h1 className="flex-1 font-poppins font-semibold ss:text-[72px] text-[52px] text-white ss:leading-25 leading-18.75">
      ...
      <h1 className="font-poppins font-semibold ss:text-[68px] text-[52px] text-white ss:leading-25 leading-18.75 w-full">
        Payment Method
      </h1>
